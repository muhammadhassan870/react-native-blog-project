...
class ShowBlog extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            selectedCategory: 0,
            categories: ['All Topics', 'Technology', 'Design', 'UI/UX','Food','Bussniss','Entertainment'],
            posts: [
                {
                    id: 1,
                    topic: 'Freelance',
                    ...
                    image:
                        'https://miro.medium.com/max/10092/1*XoD9a_cmmC9f8ZYA2rHrQw@2x.jpeg',
                    likes: 123,
                    author: 'Seth Godin',
                    minsRead: 5,
                },
                {
                    ...
                    image:
                        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1Uo6mSVyeXN9y5i6ypmbIktNYqkjD5hHnxg&usqp=CAU',
                    likes: 212,
                    author: 'Mary Jane',
                    minsRead: 25,
                },
                {
                    id: 3,
                    topic: 'Freelance',
                    title: 'Blog Post v/s Article',
                    image:
                        'https://miro.medium.com/max/2000/0*RJBXHHPczbpkqxVU',
                    likes: 123,
                    author: 'Seth Godin',
                    minsRead: 5,
                },
                {
                    ...
                    title: 'Art is Life',
                    image:
                        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROB1ua_epgC1R6DRwe35wzhF8tv15RHytZ3Q&usqp=CAU',
                    likes: 212,
                    author: 'Mary Jane',
                    minsRead: 25,
                },
    ...
    renderItem = ({item, index}) => {
        return (
            <ImageBackground
                ...
                resizeMode={'cover'}
                style={{
                    width: EStyleSheet.value(`${WIDTH / 1.2}rem`),
                    aspectRatio: 0.8,
        ...
        return (
            <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
                <View style={{flex: 1}}>
                    ...
                    {/* POSTS */}
                    <View style={{width: '200%', marginTop: EStyleSheet.value('30rem') }}>
                        ...
                        <FlatList
                            ...
                            contentContainerStyle={{paddingHorizontal: theme.appDims.boundary, paddingTop: theme.appDims.boundary ,marginLeft:"3%",paddingBottom:"5%", marginBottom:"5%"}}
                            snapToInterval={EStyleSheet.value(`${HEIGHT / 1.6}rem`)}
